function [dispar_map, sum_parab] = wrapperCSGMStereo(im_L, im_R, im_guide, params ,cost_neig, conf_score, dispar_int_val)
%% Wrapper function to run CSGM
debug_flag = 1;

if params.levels == 1
    [dispar_map, sum_parab] = currLvlCSGMStereo(im_L,im_R,im_guide, params, [], cost_neig, conf_score, dispar_int_val );
