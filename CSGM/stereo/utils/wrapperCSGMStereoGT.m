function [dispar_map_pyr, sum_parab] = wrapperCSGMStereoGT(im_L, im_R, im_guide, params ,cost_neig, conf_score, dispar_int_val,GT)
%% Wrapper function to run CSGM
debug_flag = 1;

if params.levels == 1
    [dispar_map, sum_parab] = currLvlCSGMStereoGT(im_L,im_R,im_guide, params, [], cost_neig{end}, conf_score{end}, dispar_int_val{end},GT);
...
elseif params.levels > 1
    ...
    [dispar_map_pyr{1}, sum_parab] ...
        = currLvlCSGMStereo(im_pyr_L{1},im_pyr_R{1},im_pyr_guide{1}, params, [], cost_neig{1}, conf_score{1}, dispar_int_val{1} );
    if params.plt_pyr == 1
        figure(201);
    ...
    for idx_pyr = 2:params.levels
        ...
        % Perform next step
        [dispar_map_pyr{idx_pyr}, sum_parab] ...
            = currLvlCSGMStereo(im_pyr_L{idx_pyr},im_pyr_R{idx_pyr},im_pyr_guide{idx_pyr}, params, sum_parab, cost_neig{idx_pyr}, conf_score{idx_pyr}, dispar_int_val{idx_pyr} );
