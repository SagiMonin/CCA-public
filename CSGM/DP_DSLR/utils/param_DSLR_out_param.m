function params = param_DSLR_out_param(val_gauss, val_range, val_conf, val_p1, val_sig, val_lvl, val_priorW, val_iter, ...
...
params.numIter = val_iter;[3,3,3] ; % Number of iterations 

% params.subpix = ''; 'ENCC'; 

params.cost = val_cost;'SAD'; % Cost function type
...
%% ENNC - parameter
params.encc_window = val_encc_window; [15,15];

%% Sub-pixel interpolation - This is based on simulations Sagi.K did to check pixel-locking
params.interpolant = val_interpolant;'f5';% ['f1', 'ENCC'] % Interpolation kernel for sub-pixel estimation
